...
- Índices: índice único parcial sobre `(tipo_documento, numero_documento)` donde `numero_documento IS NOT NULL` — permite varias ventas a público general sin documento sin romper la unicidad
