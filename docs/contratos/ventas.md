...
- `Deriva de RF-010`: el tope de importe para emitir una boleta sin identificar al cliente es **S/ 700** y es configurable. Superado ese importe, la boleta exige documento del cliente. Valor propuesto según la norma vigente; **queda `propuesto` hasta que el usuario lo confirme**, porque un cambio de norma o de criterio lo modifica.
