...
- Idempotencia: deduplicación mediante el índice único parcial de tipo y número de documento
...
| numeroDocumento (body) | string | requerido salvo cuando `tipoDocumento = 0`, donde debe ser null | solo dígitos para DNI y RUC; alfanumérico para carné de extranjería | DNI exactamente 8; RUC exactamente 11; carné hasta 12 | recorte de extremos; se rechazan separadores, no se limpian | longitud según el tipo; único cuando está presente | DOCUMENTO_INVALIDO / DOCUMENTO_DUPLICADO | RF-010 |
